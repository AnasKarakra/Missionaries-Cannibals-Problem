...
public class Driver_FX extends Application {
	...
	public BorderPane mainPage(String searchType) {
		BorderPane bp_loginPage = new BorderPane();
...
//						vb_top_center_right_bottom.getChildren().add(right(3, 3));
				...
				vb_top_center_left_bottom.setSpacing(20);
				vb_top_center_center_center.setSpacing(20);
				vb_top_center_right_bottom.setSpacing(20);
		...
		bp_loginPage.setCenter(sp);
		bp_loginPage.setBottom(bp_bottom);
		
		bp_loginPage.setStyle("-fx-background-color:#7ac943;");
		return bp_loginPage;
	}
